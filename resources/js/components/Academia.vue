        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <ul>
                    ...
                    <li class="list-unstyled text-center"><button class="btn btn-primary" style="border-radius:20px;margin-top:30px;background-color:#ff4900 !important"><i class="fa fa-eye"></i>&nbsp;&nbsp;Available Proposals</button>&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" style="border-radius:20px;margin-top:30px;background-color:#ff4900 !important"><i class="fa fa-info"></i>&nbsp;&nbsp;Order Your Proposal</button></li>
                </ul>
            </div>
        </div>
    </div>
