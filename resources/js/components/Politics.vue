...
<div class="row">
      ...
      <!-- writer carousel -->
            <div class="item" style="background-image:url('img/news/8.jpg');background-size:cover;color:black;background-position:center;height:500px">
                <u><h1 class="text-center" style="font-size:30px;"><span style="color:#ff4900">Flora|Digest</span>&nbsp;Services</h1></u><br><br><br>
                    <h3 class="text-center" style="font-size:15px;font-weight:bold;background-color:white;">We are the  leading public service news site in East and Central Africa</h3>
                <h3 class="text-center" style="font-size:15px;font-weight:bold;background-color:white;">Our commercial operations generate income to invest in new programmes and content</h3><br><br>
            ...
            <div class="item" style="background-image:url('img/news/5.jpg');background-size:cover;color:black;background-position:center;height:500px">
                <u><h1 class="text-center" style="font-size:30px;"><span style="color:#ff4900">Flora|Digest</span>&nbsp;<span style="color:white">Reports</span></h1></u><br><br><br>
                    <h3 class="text-center" style="font-size:15px;font-weight:bold;background-color:white;">Following the launch of our Code of Practice we’ve reviewed and assessed our internal processes to ensure we are able to hold ourselves and others to account</h3>
                <br><br>
                <br><br><br><br><br><br><br><br>
            </div>
            <div class="item" style="background-image:url('img/news/7.jpg');background-size:cover;color:black;background-position:center;height:500px">
                <u><h1 class="text-center" style="font-size:30px;"><span style="color:#ff4900">Flora|Digest</span>&nbsp;Ethics</h1></u><br><br><br>
                    <h3 class="text-center" style="font-size:15px;font-weight:bold;background-color:white;">The work undertaken through the Code of Practice has 
             ...
             <div class="item" style="background-image:url('img/news/1.jpg');background-size:cover;color:black;background-position:center;height:500px">
                <u><h1 class="text-center" style="font-size:30px;"><span style="color:#ff4900">Flora|Digest</span>&nbsp;Commercials</h1></u><br><br><br>
                    <h3 class="text-center" style="font-size:15px;font-weight:bold;background-color:white;">The Institutions Board has published a review into the its transparency in the commercial subsidiaries of the BBC.</h3>
                <br><br><br><br><br><br><br><br>
            </div>     
          </div>
    ...
    <div class="col-lg-3">
        <h3 class="h1" style="font-family:courier;text-decoration:underline;color:red">Top Political News</h3>
        <ul class="list-unstyled" style="font-size:13px">
            <li class="well well-sm" style="height:100px">
                <a href="#">
                    <img src="img/news/1.jpg" width="50px" height="50px" align="left" style="border-radius:50px">Call for in BBI proposal
                </a>
                <br>
                Voters Feel neglected over the new Constitution change drafted in Building Bridge Initiative report
                <span style="font-weight:bold;opacity:.4">Category:</span><i><b>Political &amp; Analysis</b></i>
            </li>
            <li class="well well-sm" style="height:100px">
                <a href="#">
