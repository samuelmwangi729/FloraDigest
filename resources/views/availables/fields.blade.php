...
<div class="col-sm-6">
    ...
    <input type="number" class="form-control input-md" name="budget" placeholder="Budget">
</div><div class="col-sm-6">
...
<div class="col-sm-12">
   ...
   <textarea id="summernote" name="introParagraph"></textarea>
</div>
<div class="col-sm-12">
    <label class="label-control" for="title">Introduction Paragraph</label>
   <textarea class="summernote" name="conclusionParagraph"></textarea>
</div>
<!-- Submit Field -->
