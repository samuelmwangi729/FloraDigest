...
@foreach ($news as $new)
   <div class="jumbotron">
       <div class="row">
           ...
           <a class="btn btn-primary" href="{{ route('news.single',['slug'=>$new->slug]) }}" style="border-radius:15px;font-size:15px;background-color:#ff4900 !important;font-weight:bold"><i class="fa fa-info"></i>&nbsp;&nbsp;More Information</a>
           </div>
       </div>
   </div>
@endforeach
