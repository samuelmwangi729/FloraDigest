        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse" style="font-size:15px;font-family:Arial, Helvetica, sans-serif">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                    <li><a href="{{ route('cart.index') }}" style="color:white;font-weight:bold;margin-top:10px"><i class="fa fa-shopping-cart"></i><sup class="color:red">{{ App\Cart::where('user',Auth::user()->email)->count() ?? '' }}</sup></a></li>
                    <li><a href="{{ url('/Cart') }}" style="color:white;font-weight:bold;margin-top:10px"><i class="fa fa-heart"></i><sup class="color:red">{{ App\Wishlist::where('user',Auth::user()->email)->count() ?? '' }}</sup></a></li>
