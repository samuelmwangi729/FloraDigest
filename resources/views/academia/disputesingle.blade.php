               ...
               <hr><br>
                ...
                <div class="col-sm-6">
                    <div class="form-group"><i class="fa fa-handshake"></i>
                        ...
                        <p> 
                            <a href="{{ route('dispute.undispute', [$dispute->title]) }}" class="btn btn-default" style="background-color:#562fc6 !important;color:white;border-radius:20px"><i class="fa fa-handshake"></i>&nbsp;Settle Dispute</a>
