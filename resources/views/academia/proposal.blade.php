    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <div class="pull-right">
                <a href="{{ route('client.register') }}" class="btn btn-success" style="border-radius:20px;background-color:#562fc6"><i class="fa fa-graduation-cap"></i>&nbsp;&nbsp;Client Registration</a>
            </div>
        </div>
    </div>
    <div id="app">
